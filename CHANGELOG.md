...
* accept threadId on the submit reference object ([b1b3dc7](https://github.com/Shofiul735/emailengine/commit/b1b3dc73ec5870a7a8ab9f0844055822ad046d2a))
* add an API endpoint for sending stored drafts ([16e759a](https://github.com/Shofiul735/emailengine/commit/16e759aab429160d312827618841222c7704057d))
* add anonymized feature beacon to license validation ([954d92a](https://github.com/Shofiul735/emailengine/commit/954d92a9d8e7c5fff6f1b8c711dfd228f556387a))
* add audit logging for admin authentication events ([0ea15d4](https://github.com/Shofiul735/emailengine/commit/0ea15d444ed589cd872b11190d07f7751f5cf54b))
* add direct account registration for email service account apps ([6602b2e](https://github.com/Shofiul735/emailengine/commit/6602b2ee3f851bcfec00b34e70756007763f5490))
* add EENGINE_UPDATE_CHECK_DISABLED to opt out of the GitHub update check ([e92bfe6](https://github.com/Shofiul735/emailengine/commit/e92bfe6e9b01ae9abe1cc782b51d39aac94b2341))
* add generic OIDC SSO for admin login ([71854d4](https://github.com/Shofiul735/emailengine/commit/71854d402dceff8cbf15e6ee9c059d9079ebd065))
* add group-based authorization for OIDC SSO ([c988506](https://github.com/Shofiul735/emailengine/commit/c988506f0aa860273b3128e7bc89d2274b57b6cb))
* add label/category filtering to message search ([c171c4e](https://github.com/Shofiul735/emailengine/commit/c171c4e1efe582f7e532b69108110a1c48aa3ede))
* add OAuth2 app "Verify setup" diagnostic ([cba9f58](https://github.com/Shofiul735/emailengine/commit/cba9f58bc58a434c6156cd2e55fee655336a4cf4))
* add OIDC_FORCED (SSO-only login) and OIDC_LOGOUT (RP-initiated logout) ([1751ddb](https://github.com/Shofiul735/emailengine/commit/1751ddb576f50f67ad2d8afb5bcee4db6e06b4c2))
* add Outlook Service (client_credentials) provider for app-only Microsoft 365 access ([#587](https://github.com/Shofiul735/emailengine/issues/587)) ([5f906cd](https://github.com/Shofiul735/emailengine/commit/5f906cd540564afe2dc2024b4e17c2d5d9483ed2))
* add passkey (WebAuthn) authentication for admin login ([a39b362](https://github.com/Shofiul735/emailengine/commit/a39b362152597bcc864307cd7c46cdc78a3808e6))
* add Workload Identity Federation for Gmail service accounts ([1879c5a](https://github.com/Shofiul735/emailengine/commit/1879c5aaf30ccff1879e74d28b0c76e25b3d77ae))
* **admin:** retire the bundled swagger-ui page ([34eb957](https://github.com/Shofiul735/emailengine/commit/34eb9579b19211b678283d2af62fee7c876ba6f0))
* **admin:** server-rendered API reference at /admin/reference ([2ae59f9](https://github.com/Shofiul735/emailengine/commit/2ae59f9377f0f651324e9fbed65970ffaf72c3f5))
* adopt pre-existing Gmail Pub/Sub resources with ownership tracking ([fe43fad](https://github.com/Shofiul735/emailengine/commit/fe43fadad624025a56139382428256eb810f9e08))
* allow enabling Sentry error reporting from the admin UI ([a4076a4](https://github.com/Shofiul735/emailengine/commit/a4076a4fa6658ccc998f9bfe35dddf015cd12b09))
* always use persistent sessions and support remember-me for passkey login ([6a6fc74](https://github.com/Shofiul735/emailengine/commit/6a6fc74748f92372e135e88478a9fa0f83cf690f))
* **api:** document success responses, enum values and per-operation behavior ([bbe36e6](https://github.com/Shofiul735/emailengine/commit/bbe36e6d0a2c9fb36fc1fb00fdd5f1d7b5d3cc0d))
* detect unsafe Redis eviction config in dashboard warnings ([712d5d6](https://github.com/Shofiul735/emailengine/commit/712d5d69b99cc45c6f3e123a084ef054236e0110))
* disable deprecated Document Store by default behind a feature gate ([8790f75](https://github.com/Shofiul735/emailengine/commit/8790f7538ba2ee8d6ec73d1f3bbc221c2f54f0fe))
* handle MS Graph 'missed' lifecycle event for Outlook notification recovery ([d55f48c](https://github.com/Shofiul735/emailengine/commit/d55f48c9a183f9e0108801563b1085c176dbeb06))
* **imap:** add a per-account IMAP4rev2 opt-out and account-level TLS certificate override ([59764fd](https://github.com/Shofiul735/emailengine/commit/59764fd16f5c895b2c3e714fc769482830a19a36))
* lock Gmail auth method display after app creation ([6ba16c2](https://github.com/Shofiul735/emailengine/commit/6ba16c2fbca571d500b21be776dbf5eb76fcf8a1))
* make OIDC post-logout redirect optional (OIDC_POST_LOGOUT_REDIRECT_URI) ([ae9169d](https://github.com/Shofiul735/emailengine/commit/ae9169d3f358c19370baf851479814e081625d90))
* rebuild lost IMAP sync state without replaying messageNew ([9fe391e](https://github.com/Shofiul735/emailengine/commit/9fe391e9d6350485aded780709305d698a4c65fb))
* rebuild the open source license listing ([ebe5e90](https://github.com/Shofiul735/emailengine/commit/ebe5e90d8b2e5fc76386566ed9eaf02d8fd059b0))
* replace Bugsnag with self-hosted Sentry for error tracking ([62de831](https://github.com/Shofiul735/emailengine/commit/62de831a2911da9b649fe693547ba09d70e2e481))
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([2a8c8fa](https://github.com/Shofiul735/emailengine/commit/2a8c8faf7f63acfab31998fb067289d4c6bd2f09))
* revoke upstream OAuth2 grant on account delete via ?revoke=true ([15bc43a](https://github.com/Shofiul735/emailengine/commit/15bc43ae0f8dbf70021a1e13de55c80ec7271a15))
* show curl example for service account OAuth2 apps ([4ab5eda](https://github.com/Shofiul735/emailengine/commit/4ab5edabf64373e8b2dd4bb0ea658847d40ba904))
* show human-readable missing scopes on OAuth scope error page ([4ee2365](https://github.com/Shofiul735/emailengine/commit/4ee2365449e3cbece6f4a83d540ae63c18464535))
* surface token hash for identification in API, UI, and logs ([8e2a5a9](https://github.com/Shofiul735/emailengine/commit/8e2a5a9f2bb5194e92575c34c0006a8c4e21888d))
* tag Sentry error reports with instance id and license key ([2e9683f](https://github.com/Shofiul735/emailengine/commit/2e9683f27d54ff8fa7ba3f6f4453866fd135f173))
* Tailwind v4 + FlyonUI admin UI theme ([d648da1](https://github.com/Shofiul735/emailengine/commit/d648da1ebffdaedd237437ff728eb90cdd6b54dd))
* **theme:** centralize the ACE editor fullscreen toggle ([bf9a6db](https://github.com/Shofiul735/emailengine/commit/bf9a6db8e7850c17a58feeabd2a0b45859e6d918))
* **theme:** centralize the native datalist autocomplete builder ([7b737b1](https://github.com/Shofiul735/emailengine/commit/7b737b116883b217ceaa1a49377e697b9de5333a))
* **theme:** convert auth and public layouts to Tailwind/FlyonUI ([568de9e](https://github.com/Shofiul735/emailengine/commit/568de9e5d58a83b06e270d78272d58f0a4c8de98))
* **theme:** convert config core pages to Tailwind/FlyonUI ([93f7c06](https://github.com/Shofiul735/emailengine/commit/93f7c06e7e28440dd037e9f32cfc7961f7bf099b))
* **theme:** convert Document Store pages to Tailwind/FlyonUI ([5b2b687](https://github.com/Shofiul735/emailengine/commit/5b2b6879107981ae46cdef2257ba89cbfd102dc2))
* **theme:** convert internals pages to Tailwind/FlyonUI ([06a670e](https://github.com/Shofiul735/emailengine/commit/06a670ed95d4ded7f5a303ee59891ed61b7b2981))
* **theme:** convert OAuth2 config pages to Tailwind/FlyonUI ([a787584](https://github.com/Shofiul735/emailengine/commit/a7875841b9c090a84ed9c7842887980e0aad5df6))
* **theme:** convert shared partials, replace bootstrap-autocomplete with datalists ([eb3fdf1](https://github.com/Shofiul735/emailengine/commit/eb3fdf13fc40f75aa9f529e7239e789f2b97232d))
* **theme:** convert the accounts pages to FlyonUI ([f54f5bc](https://github.com/Shofiul735/emailengine/commit/f54f5bcf4d2a9a4a5c39bf2a30f41fd9fd5a688d))
* **theme:** convert the admin shell to Tailwind v4 + FlyonUI ([d9ab031](https://github.com/Shofiul735/emailengine/commit/d9ab0318056876519edddfc51d472521cd07ee35))
* **theme:** convert the dashboard page to FlyonUI ([c4a719c](https://github.com/Shofiul735/emailengine/commit/c4a719c00f28ed134652d803f0f5b924445df0dd))
* **theme:** convert the gateways pages to FlyonUI ([6b176fa](https://github.com/Shofiul735/emailengine/commit/6b176fa8eb23890106b7e24eba32ff28ca520f54))
* **theme:** convert the tokens and templates pages to FlyonUI ([a650568](https://github.com/Shofiul735/emailengine/commit/a6505687bcd0dd17e00902a5bf8058d2494e97ab))
* **theme:** convert webhooks pages to Tailwind/FlyonUI ([77b4438](https://github.com/Shofiul735/emailengine/commit/77b4438d1957d72ac40883dedd060cf44a4cd6f3))
* **theme:** follow the admin theme in the ACE editors ([51bc909](https://github.com/Shofiul735/emailengine/commit/51bc9094eed78737d2abf085d4931b7eac570ef5))
* **theme:** move the TLS certificate labels to FlyonUI tooltips ([eabc578](https://github.com/Shofiul735/emailengine/commit/eabc578d4fd2b83b0ef951c35d76e51f3bcf9add))
* **theme:** rebuild the public pages as framework-free HTML/CSS/JS ([f3a34c0](https://github.com/Shofiul735/emailengine/commit/f3a34c0907d96cd8b393b25903fdb7be53a44ff3))
* **theme:** replace ClipboardJS with a central copy-to-clipboard handler ([216334d](https://github.com/Shofiul735/emailengine/commit/216334da310f1a076773219394f0a5c7952e3ee2))
* **theme:** restyle the stat cards to the FlyonUI dashboard idiom ([e53dd27](https://github.com/Shofiul735/emailengine/commit/e53dd27e1590554be4822d7ce08c2e4409c72b14))
* **theme:** retire the Bootstrap legacy clusters and dead assets ([836e36f](https://github.com/Shofiul735/emailengine/commit/836e36f74ee290beda1fe81d9ebddf96029ced05))
* **theme:** retire the bootstrap-compat shim and jQuery ([7669c5c](https://github.com/Shofiul735/emailengine/commit/7669c5c6f89e48c1ddb5c8f2da415c0c3ea18386))
* **theme:** sync the embedded message browser with the admin theme ([858fbcd](https://github.com/Shofiul735/emailengine/commit/858fbcdaf121c51e5a605f45c639f6cec85d175c))
* **theme:** use HSTogglePassword for the secret reveal buttons ([2ea2c11](https://github.com/Shofiul735/emailengine/commit/2ea2c1107a46c2619fb35277f24ef2f9ec0e3a25))
* **ui:** add search to the remaining paged admin list views ([22ff78f](https://github.com/Shofiul735/emailengine/commit/22ff78fe54f98be3a06334f2cc9481a6597ccf86))
* **ui:** add the account-level invalid-certificate override to the SMTP settings as well ([7d1b9e4](https://github.com/Shofiul735/emailengine/commit/7d1b9e44e91e9a251743e8b61413b4ef91a177b3))
* **ui:** align the Workers page with the list-view conventions ([8bb421b](https://github.com/Shofiul735/emailengine/commit/8bb421bf2b19e101a77301990963315b61ff71e0))
* **ui:** apply the account-view toolbar treatment to all detail views ([a6d36f0](https://github.com/Shofiul735/emailengine/commit/a6d36f067ad7f803ec7f3999a98a1349eac8478d))
* **ui:** reorganize the account view around actions, status and density ([097329e](https://github.com/Shofiul735/emailengine/commit/097329e9dcf688b5986c3a96b36f9cb49ea557db))
* **ui:** reorganize the admin menu, split settings pages, and redesign the dashboard ([4ec4118](https://github.com/Shofiul735/emailengine/commit/4ec411852f3971b8c1e6cb1e03ea98074eaeb649))
* **ui:** standardize admin list views with row actions and copyable ids ([722244f](https://github.com/Shofiul735/emailengine/commit/722244f16b08931e66ddeb929d29ec01dd44f0d3))
* **ui:** unify list-view info sections with a page-header subtitle ([925d5fa](https://github.com/Shofiul735/emailengine/commit/925d5fa80085d325c03c2c374302427ab02b8fc2))
* **ui:** use the row-actions kebab on the Workers table ([bdbb6d9](https://github.com/Shofiul735/emailengine/commit/bdbb6d90b04005c18a1e7fb3595934da24f96eb1))
* use tabs for Gmail auth method and lock it after creation ([6c74521](https://github.com/Shofiul735/emailengine/commit/6c7452138c257ecf0667aa9b44d1fa91186e2302))
* **web-safe-html:** fold quoted thread history into a collapse marker ([25d45bf](https://github.com/Shofiul735/emailengine/commit/25d45bf5b8dcc64443272f4b85178ee2c497d79c))


### Bug Fixes

* **accounts:** back out the OAuth2 auth-failure park ([bc431bd](https://github.com/Shofiul735/emailengine/commit/bc431bd3ede97d06f58788c66b7dfa8958380c49))
* **account:** serialize account updates so a refreshed token is not lost ([e577825](https://github.com/Shofiul735/emailengine/commit/e5778255710b1be912e6b259073ec963c2da03a2))
* **accounts:** make the auth-failure auto-disable work for OAuth2 accounts ([77f78b4](https://github.com/Shofiul735/emailengine/commit/77f78b4bd852c1662fee9657d84625ccdc58f143))
* add IMAP fetch retry timeout and harden passkey registration ([3a1b61b](https://github.com/Shofiul735/emailengine/commit/3a1b61b00e916c308cae5e7493a2207164d9d45f))
* add lock to del() to prevent race with ensurePubsub, fix pubSubApp cleanup ([27f2bdd](https://github.com/Shofiul735/emailengine/commit/27f2bdd4a9e3d7e913e7f4bed96084a278bb6312))
* align API response schemas with actual responses and fix uncovered API bugs ([abacbf6](https://github.com/Shofiul735/emailengine/commit/abacbf66f048a77d00d180a831a97594380d8ed9))
* align remaining API response schemas with actual responses ([06136ab](https://github.com/Shofiul735/emailengine/commit/06136abd20a97c45b25aac7f93653387eb55928a))
* always notify webhook workers when Pub/Sub app config changes ([e9f276a](https://github.com/Shofiul735/emailengine/commit/e9f276ab528ad384bcbf5c370a0d0cb22e084cc5))
* **api:** bring /v1/changes under the route-table guardrail ([d685ad8](https://github.com/Shofiul735/emailengine/commit/d685ad849fd46d0c15837278b9d30a7f195400a2))
* **api:** declare the success response for streaming and binary endpoints ([633362e](https://github.com/Shofiul735/emailengine/commit/633362e14924ee57709d18405794577285cf287f))
* **api:** match IPv4-mapped peer addresses against the address allowlists ([5acff06](https://github.com/Shofiul735/emailengine/commit/5acff061b31af6db49ffe9d856a5017bdfcaf4e7))
* **api:** require an admin session for the Bull Board queue browser ([392723e](https://github.com/Shofiul735/emailengine/commit/392723e746a83dc8fc7a96fd4c719114667f8b56))
* **api:** revert the Bull Board admin-session requirement ([14590b8](https://github.com/Shofiul735/emailengine/commit/14590b86e1557f3b6284401fbd4e1c06a9a72d01))
* **api:** trust X-Forwarded-For only from declared proxies ([6e93ea7](https://github.com/Shofiul735/emailengine/commit/6e93ea714cd75aa876f713345d675a5416b36aeb))
* **api:** warn about a spoofable admin allowlist when the proxy list is empty ([4309abe](https://github.com/Shofiul735/emailengine/commit/4309abe2d45652699f76b4adc31ff37e79802a53))
* assign unassigned accounts after license activation ([5677977](https://github.com/Shofiul735/emailengine/commit/56779778eba27f2d1604ff06f17e5736a5ddee61))
* **auth:** normalize the rate-limit window and reject a negative cost ([4c58678](https://github.com/Shofiul735/emailengine/commit/4c586783b350c38e9dd016f334b00c3d7c29cfd4))
* avoid 500 on GET /admin/totp without a partial-auth session ([b6f2394](https://github.com/Shofiul735/emailengine/commit/b6f2394182379d94a05f95c84f5ce04ae6f87a05))
* bound inbound line length in the IMAP proxy parser ([9fb8a5e](https://github.com/Shofiul735/emailengine/commit/9fb8a5e301564dee46b48ca32a5b84e4832d96e8))
* broaden Pub/Sub notification condition in oauth-routes.js ([cbe1380](https://github.com/Shofiul735/emailengine/commit/cbe13800ab9460c41f5dcdcd4d7ae50f8e5e75e3))
* broken Handlebars script tag, Okta session fall-through, login rate limiting, and passkey schema validation ([01e5721](https://github.com/Shofiul735/emailengine/commit/01e5721ee02ad66ce9c30b58c406988b1cfd1ae3))
* bump dependencies and refresh generated artifacts ([4de7381](https://github.com/Shofiul735/emailengine/commit/4de7381d994058371adfd3e665c98c46d46431e8))
* bump ee-client/sentry-node/bullmq and refresh generated artifacts ([b365690](https://github.com/Shofiul735/emailengine/commit/b365690a49e1d526b691c9c38ad1f8f6cfa6418a))
* bump imapflow to 1.4.4 (dedupe nodemailer/iconv-lite) ([5acc8cd](https://github.com/Shofiul735/emailengine/commit/5acc8cd99f9179fabb8d8486cf23b0558e4514bf))
* bump imapflow/bullmq/bull-board/sentry-node/eerawlog/prettier ([8f7b6bf](https://github.com/Shofiul735/emailengine/commit/8f7b6bf21eae70b1f3c8e0856a6c0f0a0d641317))
* bump imapflow/mailparser/mailsplit/email-ai-tools (collapse iconv-lite) ([51dcffb](https://github.com/Shofiul735/emailengine/commit/51dcffb3ff0f22f9b9634d078e58b35aaf7a0312))
* bump libmime/mailparser/smtp-server/pubface (uniform nodemailer) ([eee89bb](https://github.com/Shofiul735/emailengine/commit/eee89bb716655519c72fb922849272c1058cbc9a))
* bump sentry-node/bullmq/nanoid/eslint and refresh generated artifacts ([d9c26df](https://github.com/Shofiul735/emailengine/commit/d9c26df99a04f2ab0c6465e4bd2f311ea3ebc0dd))
* cap webhook delivery attempts with a wall-clock timeout ([ca263d7](https://github.com/Shofiul735/emailengine/commit/ca263d7523c625c6b0f1b8f6dda172b6ee962d7c))
* **ci:** give the Docker builds a cache backend and smoke test by digest ([4554d90](https://github.com/Shofiul735/emailengine/commit/4554d90b5bf38f649b8c27c65a9c26cf39951e0d))
* **ci:** smoke-test the image before publishing and harden the allowlist test ([c285fcb](https://github.com/Shofiul735/emailengine/commit/c285fcbbd258846537447cd730342423e6b2eaf7))
* clear passkey credentials on CLI password reset and document remember-me behavior ([35f7f00](https://github.com/Shofiul735/emailengine/commit/35f7f00970b7e7f3a514d2ea0d97fce5320f6e1b))
* clear the connecting flag if loading account data fails during reconnect ([8d82167](https://github.com/Shofiul735/emailengine/commit/8d8216730f809eebdc8a0762e38f93f0084de038))
* clear the pending changes debounce when closing a subconnection ([a286f89](https://github.com/Shofiul735/emailengine/commit/a286f89e721336b64a9c16737cf30d161f52fe22))
* clearer error when loading wrong file into WIF config field ([40686d4](https://github.com/Shofiul735/emailengine/commit/40686d409229347193c1e153e9e47f98b5de86dc))
* close command client proactively after subconnection setup ([02d3687](https://github.com/Shofiul735/emailengine/commit/02d36874d8533beabe5ad0fba978851b3791cbb5))
* close leaks and a worker crash found in the connection hardening review ([e97950e](https://github.com/Shofiul735/emailengine/commit/e97950e7e907ac5b5549302b8865c5d2bfb0d6e2))
* constant-time MS Graph clientState check and escape unsubscribe email ([3def225](https://github.com/Shofiul735/emailengine/commit/3def225ab1d598dec4f0b44443ff842295736039))
* correct translation errors and remove EmailEngine branding from OAuth scope error ([9284ddd](https://github.com/Shofiul735/emailengine/commit/9284ddd1e28e40fd24abeea7296636b21c4b3878))
* count undecodable export queue entries as skipped ([72e2498](https://github.com/Shofiul735/emailengine/commit/72e2498390f17ad24d5f7b1577540674d7e1fe09))
* defer export worker job consumption until startup recovery completes ([a21b0a5](https://github.com/Shofiul735/emailengine/commit/a21b0a50fdb98d13a2227a020069129d23fe225b))
* **deps:** bump imapflow to 1.6.1 to restore IMAP account verification ([c2a5437](https://github.com/Shofiul735/emailengine/commit/c2a543779b29c369d35bfbbc175810fc1d96f02c))
* **deps:** update @postalsys/email-ai-tools to 1.13.15 ([89ec145](https://github.com/Shofiul735/emailengine/commit/89ec145a8f43a29405cf154825601dd8ba10fae6))
* **deps:** update dependencies ([3370f0a](https://github.com/Shofiul735/emailengine/commit/3370f0aa3afeb3b07bb5627602a314ec6aaf89fa))
* **deps:** update dependencies ([e1256b2](https://github.com/Shofiul735/emailengine/commit/e1256b296f83be3fe161f38af5087d231c8fa3bf))
* **deps:** update dependencies ([3961788](https://github.com/Shofiul735/emailengine/commit/396178803b45ad4d4d428ec637de747bd14756d1))
* **deps:** update dependencies ([@bull-board](https://github.com/bull-board) 8.3.2) ([a5644f3](https://github.com/Shofiul735/emailengine/commit/a5644f34e56128451c642d2034ddf7db0d1cc7a8))
* **deps:** update dependencies (@postalsys/ee-client 1.7.0) ([9c440b2](https://github.com/Shofiul735/emailengine/commit/9c440b2c4e94f975267a0562022bdebc86524c9f))
* **deps:** update dependencies (@postalsys/email-ai-tools 1.13.14) ([027f065](https://github.com/Shofiul735/emailengine/commit/027f0654a1a5d844dd02a22d1f594927e4c4e258))
* **deps:** update dependencies (imapflow 1.5.0) ([8cc45ac](https://github.com/Shofiul735/emailengine/commit/8cc45acacb8572d5cf9a187a34d6d284b57d4b99))
* **deps:** update dependencies (imapflow 1.6.3) ([7dc423c](https://github.com/Shofiul735/emailengine/commit/7dc423cafe45206c36b8293f1a57f47f56594dfe))
* **deps:** update dependencies (imapflow 1.6.5) ([6a350e1](https://github.com/Shofiul735/emailengine/commit/6a350e1ab7e8b96ae089d0768c2a9300e0a405e0))
* detect IMAP drift that landed during an in-progress sync ([8fece8a](https://github.com/Shofiul735/emailengine/commit/8fece8ad6f3acb5e7391da7a9740279099f62177))
* disable subconnection when the monitored mailbox no longer exists ([e1895d6](https://github.com/Shofiul735/emailengine/commit/e1895d64b5fd17912f582406c7c352b9176364c6))
* distinguish SO_REUSEPORT fallback cause in logs and admin UI ([99ad9f3](https://github.com/Shofiul735/emailengine/commit/99ad9f3359eab5bafc4726535584874d4823f7bd))
* do not crash at startup when a feature flag env variable is set to a falsy value ([98ad979](https://github.com/Shofiul735/emailengine/commit/98ad97988e752fad9e2ae11eff63f35ffcf84976))
* do not prefill login username field ([59835a8](https://github.com/Shofiul735/emailengine/commit/59835a84f3e2a01c6461f29ecb80763dc4a42fe2))
* do not report connectError when pause() interrupts a connection attempt ([4d38e4f](https://github.com/Shofiul735/emailengine/commit/4d38e4f047be16f4f5a16a0274c5240346c2b50f))
* **docker:** ship the root-level CLI modules in the image ([a63cb4e](https://github.com/Shofiul735/emailengine/commit/a63cb4e17b3fac9b8e003914b3472f1da20dd6ec))
* drain webhook response body on every delivery path ([2cc3e7a](https://github.com/Shofiul735/emailengine/commit/2cc3e7aef114b5b913dea5c363278e1a883d5a48))
* drop the reconnect timer handle when closing an IMAP connection ([9f46c77](https://github.com/Shofiul735/emailengine/commit/9f46c77afef8217a8b6b69e736cb0cd38b27429b))
* escape Redis glob metacharacters in account-scoped SCAN patterns ([603d9db](https://github.com/Shofiul735/emailengine/commit/603d9dbce9c4e21b390e10dc7499f2cc5989c875))
* escape untrusted email fields in message browser to prevent stored XSS ([1159cc1](https://github.com/Shofiul735/emailengine/commit/1159cc193a98eb972454a5ae61ec01d7df77f06a))
* **export:** correct the concurrency limits and the active-set ownership ([690934a](https://github.com/Shofiul735/emailengine/commit/690934a0ecf8cbaa5374f0d44ae6881f708ff914))
* extract gettext strings from the decomposed ui-routes modules ([227e60f](https://github.com/Shofiul735/emailengine/commit/227e60ff4f354c5d0f55534877c8ab6fbdd92c7d))
* fail export when a folder cannot be indexed ([36c9c9d](https://github.com/Shofiul735/emailengine/commit/36c9c9d536540cd5a61b16b69af5e8e84c194ee6))
* filter transient fetch failures from Sentry and retry DNS errors ([883b9b4](https://github.com/Shofiul735/emailengine/commit/883b9b487e3580c5b1240d28cd519d190c402b47))
* fix export TTL expiration, cancellation cleanup, and expose truncated field ([019c05c](https://github.com/Shofiul735/emailengine/commit/019c05c941842ae28668711e8f5c2e8a85d3b84b))
* fix lifecycle event races, lock TTL, and stale clearExisting in MS Graph subscriptions ([3f3cbac](https://github.com/Shofiul735/emailengine/commit/3f3cbac843c4c221644492855d7c1beb41cd1da0))
* fix missing renewal retry, clock-skew gap, and incomplete pipeline error check ([8a8b5b6](https://github.com/Shofiul735/emailengine/commit/8a8b5b68feb3edd7c984707a85ddb6d146739020))
* fix off-by-one retry cap and simplify MS Graph subscription code ([aa9afbc](https://github.com/Shofiul735/emailengine/commit/aa9afbc5aea20d1bf775e59dbfd82842c4f8b701))
* fix Pub/Sub deletion race, add 429 handling, batch ACKs, and lock ensurePubsub ([744c354](https://github.com/Shofiul735/emailengine/commit/744c354a062f63eedcec8de1a324a5d13519b9a7))
* fix retry boundary, lock races, and dropped lifecycle events in MS Graph subscriptions ([d62741d](https://github.com/Shofiul735/emailengine/commit/d62741d2a2aafc47d831482b71ff24fa4c9d1883))
* fix silent 401/403 error suppression, floating promise, and recovery loop in Pub/Sub ([406211c](https://github.com/Shofiul735/emailengine/commit/406211cbd62f7d3f1b811fbec81767f319219c63))
* fix stale subscription state blocking recovery and retry count persisting across reconnects ([60b77d5](https://github.com/Shofiul735/emailengine/commit/60b77d5d7574abf728c5e1f015c0cecddd5d9fdd))
* fix subscription loss on subscriptionRemoved, lifecycle webhook timeout, and retry gaps ([62988ab](https://github.com/Shofiul735/emailengine/commit/62988ab3b690ed98583fa01557a9c4145427e3ae))
* flag WIF support in the gmailService form intro ([61fab27](https://github.com/Shofiul735/emailengine/commit/61fab2720aa2f289a944ae99629bc47ada8e9e09))
* force-exit external-account-signer test to unblock CI ([f4a1e4e](https://github.com/Shofiul735/emailengine/commit/f4a1e4e50ac890d7771e38181a9488837c67757a))
* gate hosted auth form with a single-use nonce and probe cap, harden serviceSecret ([7ea4ff7](https://github.com/Shofiul735/emailengine/commit/7ea4ff7e6ca4d9239201f556b24ebd9cf8ab8250))
* **gitignore:** cover every local env file, not just the exact name ([16124d5](https://github.com/Shofiul735/emailengine/commit/16124d5e83cb9ead3a0c8520db7fcb4e5eefedaa))
* guard cross-thread download streams against early producer errors ([191ec62](https://github.com/Shofiul735/emailengine/commit/191ec6204887c3abe78da7a9944e3165b19c0b87))
* guard IMAP notification handlers against malformed events ([0248953](https://github.com/Shofiul735/emailengine/commit/0248953a5dcccba5d46704bf7113a70fb5ac3150))
* guard releaseLock against undefined, add 429 handling to Pub/Sub deletion ([d67ebe1](https://github.com/Shofiul735/emailengine/commit/d67ebe138ca9663796eacc5a1c6b5b73e721e6c4))
* guard webhook notifications in BullMQ failure handlers ([e90048e](https://github.com/Shofiul735/emailengine/commit/e90048e7b7bd92916219602f92305342234df4a3))
* handle TimeoutError from AbortSignal.timeout in Pub/Sub pull loop ([c0e3036](https://github.com/Shofiul735/emailengine/commit/c0e303641e4eb9f6cdca3c584861052b2bd91148))
* harden hosted authentication form (SSRF gate, fail-closed HMAC, XSS) ([4267df7](https://github.com/Shofiul735/emailengine/commit/4267df7fd0252aa84ff1d257846126a8f943bf1a))
* harden IMAP proxy STARTTLS against command injection ([3661ddd](https://github.com/Shofiul735/emailengine/commit/3661dddbf216b29ec8f074d3f6422dd4db5d9e7b))
* harden inter-thread IPC (worker-death call rejection, webhook guards, stream cleanup) ([0111a8e](https://github.com/Shofiul735/emailengine/commit/0111a8e2bf139c3412cc37e5e933fd5316cee8fc))
* harden mergeObjects and tighten CodeQL scanning ([d35025d](https://github.com/Shofiul735/emailengine/commit/d35025daabf8fe7b3f5200b0000f52c3a012f4eb))
* harden message export against data loss and corruption ([540d867](https://github.com/Shofiul735/emailengine/commit/540d8678ec25f62e8123fc78fa929f4e4713b5d4))
* harden MS Graph subscription lifecycle, locking, cleanup, and error recovery ([8210056](https://github.com/Shofiul735/emailengine/commit/8210056f7e7b00977fb5487323ff1b8f9f4b7a99))
* harden multiple-API-worker startup and centralize proxy-agent reload ([7f2db9e](https://github.com/Shofiul735/emailengine/commit/7f2db9e557d960aa1b7523b7d8678598683c2f29))
* harden passkey auth, IMAP sync error handling, and login form UX ([c16b983](https://github.com/Shofiul735/emailengine/commit/c16b98312f35d87fd8b21974a7eb7eca6459cc3b))
* harden passkey authentication with validation, rate limits, and audit logging ([75dd289](https://github.com/Shofiul735/emailengine/commit/75dd289940e7345fa56246c90ff6bc8d01694e6c))
* harden Pub/Sub pull loop resilience and fix projectId typo ([8124328](https://github.com/Shofiul735/emailengine/commit/81243287f339b5fe40cddd0e1d127514d2e11f4a))
* harden Pub/Sub pull loop, message ACK, list pairing, and shutdown cleanup ([9e9775f](https://github.com/Shofiul735/emailengine/commit/9e9775f6df97af42bdb8b799c2345a4564f8a77a))
* harden Pub/Sub pull loop, worker coordination, and OAuth app lifecycle ([529b705](https://github.com/Shofiul735/emailengine/commit/529b7055dd4aeb0b1d80fabff3f139cf23f00252))
* HTML-escape json Handlebars helper to prevent stored XSS in error logs ([af2c153](https://github.com/Shofiul735/emailengine/commit/af2c153eb4d7de06b2730da6fdeb17bbe868472b))
* ignore \NonExistent folders in mailbox listing ([7ec96cf](https://github.com/Shofiul735/emailengine/commit/7ec96cfaaf5425c16479151e66ef3285c854b49a))
* **imap:** keep an error sink on abandoned IMAP connections ([a9ef9e3](https://github.com/Shofiul735/emailengine/commit/a9ef9e3fe380cd3752a1121a0741559fbd8229b7))
* **imap:** park phantom folders and throttle short-lived-connection reconnects ([da97da3](https://github.com/Shofiul735/emailengine/commit/da97da31eddcb327672daf28938efec11b5e55f7))
* **imapproxy:** keep an error sink on the upstream proxy connection ([653259d](https://github.com/Shofiul735/emailengine/commit/653259d7e5a9558489eccea1ead8c50856274dd2))
* **imap:** report account log write failures instead of crashing the worker ([e881e65](https://github.com/Shofiul735/emailengine/commit/e881e6593ffa0f4ace027e9287124b3bde3a3edb))
* **imap:** stop re-listing the folders on every connection setup ([6d79eb3](https://github.com/Shofiul735/emailengine/commit/6d79eb3f67a3d2bb826f43483c4e51d03ea98d8a))
* **imap:** stop the OAuth token renewal reconnect loop that pinned the CPU ([eff5727](https://github.com/Shofiul735/emailengine/commit/eff5727f4a328326609856861465f524e381689c))
* **imap:** stop wiping the folder listing on an unusable LIST response ([f6229bb](https://github.com/Shofiul735/emailengine/commit/f6229bb72a8a6cd415a3c738740b9dc64dfbfb9d))
* **imap:** store the connection error response as text, not as a parsed object ([3cf8d2e](https://github.com/Shofiul735/emailengine/commit/3cf8d2e016ce0e8ce623468689ef6f21a90cd6f1))
* **imap:** tolerate a FETCH response that omits FLAGS ([b78b314](https://github.com/Shofiul735/emailengine/commit/b78b314396ea6eec7e23d707044cf46d1f51899c))
* improve translation quality across 6 languages ([d7d338e](https://github.com/Shofiul735/emailengine/commit/d7d338e761152909d4c2ca4732fafb60529413ab))
* include failed jobs in /v1/outbox response ([b393676](https://github.com/Shofiul735/emailengine/commit/b393676f2f877046d27b06d518a03dd256d5b7d9))
* keep dashboard stats counters for the intended retention period ([db175f7](https://github.com/Shofiul735/emailengine/commit/db175f7161315d95b51e79c5183541995a595e72))
* let npm run gettext parse object spread and drop non-ASCII from template ([195ce60](https://github.com/Shofiul735/emailengine/commit/195ce601db50f394164ca05e2efb6de4b784a77a))
* list Outlook folders with slashes in the name ([dd35e7b](https://github.com/Shofiul735/emailengine/commit/dd35e7b262a47f9395811d75c4bcc1d9ab4c6ec0))
* log expected API client errors (4xx) at warn instead of error ([c51e347](https://github.com/Shofiul735/emailengine/commit/c51e3476e346f321af845905a89141bf07a83421))
* **logging:** stop logging decrypted setting values and lower Redis reconnect noise ([5c62ac4](https://github.com/Shofiul735/emailengine/commit/5c62ac486112688e8a964c66a43eb609abe7c8da))
* login page divider logic, select() log level, and missing trailing newlines ([97ff93e](https://github.com/Shofiul735/emailengine/commit/97ff93e2cc6c865a0f597a42a124e0abb140e34a))
* mask externalAccount in OAuth2 app API responses ([fac18bf](https://github.com/Shofiul735/emailengine/commit/fac18bfdc11d5d252e0d93980aad7c90d92b246f))
* mint a session sid on every admin login path ([e166fbf](https://github.com/Shofiul735/emailengine/commit/e166fbf5e5398a8f7bf6b6d1b08025908b374d89))
* normalize copy across login and security pages ([60e132a](https://github.com/Shofiul735/emailengine/commit/60e132a9e4e8f96fc621b4b454f95896fb4d48c1))
* normalize sign-in/sign-out copy to sentence case ([1ccfb16](https://github.com/Shofiul735/emailengine/commit/1ccfb167a674d887af0ac2db8df3ff434f23e5bb))
* **oauth:** drop the transient token-refresh carve-out, keep the stale-token fix ([63c2d8c](https://github.com/Shofiul735/emailengine/commit/63c2d8c261a71158ea5670ddc7e080c690240265))
* **oauth:** make the transient token-failure and delivery-retry fixes actually fire ([5049fea](https://github.com/Shofiul735/emailengine/commit/5049fea5f1724d4e7ae2fa6f2b58a642af4f7f6b))
* **oauth:** pin external account token_url to Google STS ([27ade81](https://github.com/Shofiul735/emailengine/commit/27ade8183cd31b503077ebefd5724f2f0620947d))
* **oauth:** report transient token failures instead of stalling on them ([10b3480](https://github.com/Shofiul735/emailengine/commit/10b348082016f047eda641602bfe370d1195e222))
* **oauth:** stop reporting a rate-limited token endpoint as bad credentials ([de27fca](https://github.com/Shofiul735/emailengine/commit/de27fca5ed0c42cabb95553a00323dc82fc422bc))
* only reseed lost IMAP sync state when no stored state exists ([78e0141](https://github.com/Shofiul735/emailengine/commit/78e0141e9f3478d2a2a1206c805258c6807a45d8))
* override grunt's transitive js-yaml to 3.15.0 (GHSA-h67p-54hq-rp68) ([024a923](https://github.com/Shofiul735/emailengine/commit/024a923de3ff2a880e79c7ddbf34bbc058fcbea3))
* per-IP passkey rate limiting and credential ownership check ([2455cbe](https://github.com/Shofiul735/emailengine/commit/2455cbe9d6af5d6eff8ae81ecc335b6820bfc904))
* pin undici to 7.25.0 for Node 20 compatibility ([3fa80db](https://github.com/Shofiul735/emailengine/commit/3fa80db4d64d6fe089fa3a1a0e700a188aeb74f7))
* pkg config options must be a string array ([6c4702d](https://github.com/Shofiul735/emailengine/commit/6c4702dbc85171a2987b8cfb6e5a3dc3d656a99d))
* point documentation links to the learn.emailengine.app docs site ([f947b27](https://github.com/Shofiul735/emailengine/commit/f947b2770d55c6d8a26f1944416ed449b561af32))
* prefer refresh token and skip gmailService when revoking on delete ([e0dbea8](https://github.com/Shofiul735/emailengine/commit/e0dbea8a4cd4804bf64d50523c8a1152c2119e26))
* prevent IMAP proxy worker crashes and connection leaks ([#596](https://github.com/Shofiul735/emailengine/issues/596)) ([4453330](https://github.com/Shofiul735/emailengine/commit/4453330ad38fb3e64692add1357d48227e1956e0))
* prevent IMAP worker crash on download stream errors ([d9d5396](https://github.com/Shofiul735/emailengine/commit/d9d539632cc245a8e2a14585fc7918186bee00b6))
* prevent message event loss during IMAP sync under heavy load ([ceb139b](https://github.com/Shofiul735/emailengine/commit/ceb139b825eaf7fc06bf1c88b9bcc89824abbcdb))
* prevent open redirects via next parameter and require password for passkey registration ([0e7f52a](https://github.com/Shofiul735/emailengine/commit/0e7f52ada9687234682027ecb93e81515fcb9dbb))
* prevent oscillating recovery loop for Pub/Sub apps missing googleProjectId ([8bdbc39](https://github.com/Shofiul735/emailengine/commit/8bdbc39c790b7097b02459b558328c18584585a2))
* prevent overlapping and revived subconnection reconnect cycles ([5754c07](https://github.com/Shofiul735/emailengine/commit/5754c074f0f8c89222008e4c1d331b66891b3c16))
* prevent post-BYE command dispatch in IMAP proxy teardown ([d51e92d](https://github.com/Shofiul735/emailengine/commit/d51e92d298e9373a6dc5c2eb0919885e161b45c7))
* prevent unhandled promise rejections during mailbox sync ([e6174de](https://github.com/Shofiul735/emailengine/commit/e6174defbf1c94f54ac7cbcb45eaa9e5c547926e))
* process refreshed folder listings so new folders emit mailboxNew ([247c325](https://github.com/Shofiul735/emailengine/commit/247c325cc71f1842cc8083c7fd025792217c77d8))
* **queue:** retain failed queue entries instead of deleting them on arrival ([e83af35](https://github.com/Shofiul735/emailengine/commit/e83af359aafc49d584cd0c234e089e9dceb83f3b))
* re-arm a generous idle timeout for proxied IMAP connections ([627c6d4](https://github.com/Shofiul735/emailengine/commit/627c6d472e50f6fc3e958e4774226557a526018d))
* reconcile disabled and active subconnections in setupSubConnections ([85ebb54](https://github.com/Shofiul735/emailengine/commit/85ebb54bae8d4d7321a7362bb20e570a149fe892))
* reconnect error-state accounts after OAuth re-auth via create() ([77cee1e](https://github.com/Shofiul735/emailengine/commit/77cee1eb1916fbd6582cfcf931023d53f6cc8abf))
* refresh folder listing when a listed mailbox is missing on SELECT ([1e54d32](https://github.com/Shofiul735/emailengine/commit/1e54d32c1c74cb1f6d3d085a75d5b5ecc1cf5ff2))
* reject in-flight worker calls when a worker thread terminates ([08e7b01](https://github.com/Shofiul735/emailengine/commit/08e7b0128a4b8e9f9e5a96fefe49110bd032bd2c))
* reject OAuth2 grants with missing Google granular consent scopes ([3f277d1](https://github.com/Shofiul735/emailengine/commit/3f277d1428e4a861752eb18b5d74279afefd1efa))
* relax cross-folder assertion in Graph API parentFolderId test ([770279d](https://github.com/Shofiul735/emailengine/commit/770279ded669efdc5d6a2c33d05290daf91251ea))
* release cross-thread download streams on abort and error ([6514249](https://github.com/Shofiul735/emailengine/commit/65142499d095bbcb5f0bb49755a2e24f6e52fa62))
* release MessagePort streams when message/attachment downloads fail ([787f4f5](https://github.com/Shofiul735/emailengine/commit/787f4f5ef6364ec1389c15269c8f7f8eaaa2142a))
* remove dead circuit breaker code from IMAP and webhooks workers ([da9295b](https://github.com/Shofiul735/emailengine/commit/da9295b951d20a5817116195689dd3c964b3d996))
* remove password hash from error logs and update passkey description copy ([d28dd16](https://github.com/Shofiul735/emailengine/commit/d28dd16e61fc84d0800546c4f33d4535f52e2a22))
* remove Pub/Sub circuit breaker, fix 401/403 recovery handling ([b7017f3](https://github.com/Shofiul735/emailengine/commit/b7017f34478dbb3bcedfb9a1e098a8a45cb0f83d))
* remove unnecessary min-height from login form ([f16940d](https://github.com/Shofiul735/emailengine/commit/f16940d9957df114ce0ff4240107a82619a58705))
* reorder OAuth app deletion to prevent pull-loop gap, add startLoop tests ([129f96c](https://github.com/Shofiul735/emailengine/commit/129f96c99ff9ff2552fa1c1962b1e0a652b8837e))
* replace custom Redis locks with ioredfour in Outlook subscription code ([019eaa1](https://github.com/Shofiul735/emailengine/commit/019eaa1f26be504d127cb6c8a05dfe50d8a47b71))
* report correct nextAttempt time for queued messages ([d5ebdfb](https://github.com/Shofiul735/emailengine/commit/d5ebdfb029b3ed331a8239ace7426f4f0704ae2e))
* require an exact path match in the missing-mailbox verification LIST ([54e23c4](https://github.com/Shofiul735/emailengine/commit/54e23c4f6f13d3d834348df4bf15cf11206dc58b))
* reset IMAP reconnection backoff only after a successful sync ([7138dab](https://github.com/Shofiul735/emailengine/commit/7138dabab866483818440478d3584a46dfc8de12))
* reset subconnection backoff only after the monitored mailbox is opened ([f2bf297](https://github.com/Shofiul735/emailengine/commit/f2bf297883c38f4d1f61197ae75bdd7ae3976a53))
* resolve code review findings in Gmail bulk ops, exports, webhooks, and schemas ([f0ddb46](https://github.com/Shofiul735/emailengine/commit/f0ddb4631fb924ddb93e0a99d0e20bc9f0cc8ee2))
* resolve lint errors, fix TTL null guard, and extract Pub/Sub constants ([4949431](https://github.com/Shofiul735/emailengine/commit/4949431c8e05f06c5aafc3dfe93876ea8a2875b9))
* resolve livelock, timeout, and state corruption in MS Graph subscription lifecycle ([745334e](https://github.com/Shofiul735/emailengine/commit/745334e8c55fcf4b0b3fc6adef2b37f6cf9aea61))
* resolve OAuth2 provider for delegated Outlook accounts ([f35c816](https://github.com/Shofiul735/emailengine/commit/f35c816e3149eeaa568d86c06fa6783c649c54c5))
* resolve the mailbox sync promise when a concurrent operation already selected the mailbox ([7327dcc](https://github.com/Shofiul735/emailengine/commit/7327dcc9479a991881d3ddafdd0f36cc69e3411d))
* resolve the mailbox sync promise when opening fails before the sync starts ([c2268af](https://github.com/Shofiul735/emailengine/commit/c2268af90bea13d5b804c0a84945801cd9d74e45))
* restore IMAP XOAUTH2 path for gmailService accounts ([d2ebe9b](https://github.com/Shofiul735/emailengine/commit/d2ebe9b3c19cd0bcaaf0fa17d40148f79dd7cd2b))
* restore the scan CLI command and stop packing secrets into the tarball ([edddb4e](https://github.com/Shofiul735/emailengine/commit/edddb4e70e96a7267880e295f0d9448b16ed214e))
* resume sync after OAuth re-auth and enable Run sync for Gmail/Outlook ([f3bef82](https://github.com/Shofiul735/emailengine/commit/f3bef823ee90cd6fcf90b95fadcb6f2730657441))
* retry transient account data load failures during reconnect ([7f18d4b](https://github.com/Shofiul735/emailengine/commit/7f18d4b16ccdfcfde77eb433530636b8657a354a))
* retry transient errors during Pub/Sub resource deletion and log dropped messages ([b9d9de5](https://github.com/Shofiul735/emailengine/commit/b9d9de56a50b37e0163ea4e9a954d65bc305004c))
* retry transient errors in API-account batch export path ([6cba7c7](https://github.com/Shofiul735/emailengine/commit/6cba7c72658a037f68867cf2464f7d3420a79507))
* return 422 for unsupported label search and surface Outlook categories ([d981359](https://github.com/Shofiul735/emailengine/commit/d981359b78b61d2c8a03e4e35086a4c9674ce53a))
* return the append destination folder from uploadMessage ([96aed6b](https://github.com/Shofiul735/emailengine/commit/96aed6b1144e1d3ee9da79b3a1fb03606245f83c))
* revive missing-folder subconnections when the folder is re-created ([254fce4](https://github.com/Shofiul735/emailengine/commit/254fce4f0eca59bc52ed4a8235f581b8107b97a7))
* right-align the service account Add account button ([c6f77b9](https://github.com/Shofiul735/emailengine/commit/c6f77b9777fb1cb9b1449662d05d4887e36a6ad8))
* scope the re-entrant open latch to the connection that emitted the event ([627b6ee](https://github.com/Shofiul735/emailengine/commit/627b6eeaf9ed493f6a4d81adcbe5b766eba54682))
* send correctly typed SMTP and IMAP proxy state change notifications ([3fbd27f](https://github.com/Shofiul735/emailengine/commit/3fbd27fc08bb74f9738a3fc95d4177fa4978c263))
* **server:** drain workers on shutdown and back off crash-looping respawns ([29b3b5d](https://github.com/Shofiul735/emailengine/commit/29b3b5d0d7b76793ea2852c9a37a8c622217a6ea))
* **setup:** create production secret files owner-only ([52f0527](https://github.com/Shofiul735/emailengine/commit/52f052741558e9b3a5478fe2f0ecc5fb0a1679f9))
* skip mailboxes that can not be selected during account sync ([eaf09c1](https://github.com/Shofiul735/emailengine/commit/eaf09c1700eca77e27fada20371bad193e0665c8))
* skip re-entrant mailbox open events while onOpen is already running ([6d06b09](https://github.com/Shofiul735/emailengine/commit/6d06b09c0c573a2f8ca554ba85c75d6b7be87002))
* **smtp:** handle MIME parse errors and enforce the message size limit ([e70eb7d](https://github.com/Shofiul735/emailengine/commit/e70eb7df40245118752cf276cb70090647573216))
* **smtp:** reject an unparseable message permanently instead of with a 450 ([ef77542](https://github.com/Shofiul735/emailengine/commit/ef775420a15d94c6a46d6eefe6d37413b5330e6c))
* **sso:** reject unverified OIDC emails in the admin allow-list ([34ff519](https://github.com/Shofiul735/emailengine/commit/34ff51997bc75e74787542c59ccca24e7db4e24c))
* **sso:** treat any present email_verified value as a strict boolean ([89821cc](https://github.com/Shofiul735/emailengine/commit/89821cc809d6fc1160062115b6c56be1f44a4939))
* stop logging the MS Graph access token on HTTP 401 ([f2f0300](https://github.com/Shofiul735/emailengine/commit/f2f03008cbcbaba8b7c2ff9c043ede7930c5c4ef))
* stop opening IMAP connections for accounts paused while connecting ([128aef3](https://github.com/Shofiul735/emailengine/commit/128aef3cf2b7f1485a2e3d291436e88183255c0e))
* stop referencing prepared password string in error log ([50cdb89](https://github.com/Shofiul735/emailengine/commit/50cdb8998e27f33f700f267cb39ddba39e7d32d0))
* **submit:** retry transient 4xx SMTP rejections and gate token minting on the request principal ([1688c86](https://github.com/Shofiul735/emailengine/commit/1688c86522d9e79715569e6735353c333d7e527c))
* **submit:** stop discarding queued mail on non-SMTP 5xx errors ([f80f475](https://github.com/Shofiul735/emailengine/commit/f80f4754c76e230db529031c0549caf26468d891))
* surface TTL reconciliation failures to operators via ttlWarning meta flag ([6e5d5c5](https://github.com/Shofiul735/emailengine/commit/6e5d5c5a97fb9aaff2662f3fe2f90c8226359b4a))
* switch pkg targets from node22 to node24 to fix Windows builds ([12522a7](https://github.com/Shofiul735/emailengine/commit/12522a7b92d72684af49cd70c1c6d4bcafe1d4af))
* tear down subconnections when deleting an IMAP account ([bd81a33](https://github.com/Shofiul735/emailengine/commit/bd81a33caf9400cbee2781a9180f1a901c1d6e48))
* **test:** provision scope-test tokens as a trusted local caller ([20ca781](https://github.com/Shofiul735/emailengine/commit/20ca7817f3679797bb07e17d00e9b4cd5d6d7c4b))
* **theme:** align the SSO setup buttons on the account security page ([aee2d34](https://github.com/Shofiul735/emailengine/commit/aee2d34d753f8b86c824fff1f9d7ace4e339b171))
* **theme:** apply the post-merge release review findings ([d36ce1b](https://github.com/Shofiul735/emailengine/commit/d36ce1b8309f8be6fd5b3923147c9a3e105e2bbf))
* **theme:** apply the whole-branch review findings ([965e652](https://github.com/Shofiul735/emailengine/commit/965e652351f46778341c37af87bfa8f4509158fc))
* **theme:** cap tooltip width so long texts wrap ([a805b3b](https://github.com/Shofiul735/emailengine/commit/a805b3b2729630c02f5a7863fe0d899e0517eb38))
* **theme:** gate TLS certificate provisioning on a usable service domain ([ef22689](https://github.com/Shofiul735/emailengine/commit/ef226897493fa700c3dd6a56afee4e14ada48559))
* **theme:** indicate the selected tab in the admin UI tab strips ([2aa6d22](https://github.com/Shofiul735/emailengine/commit/2aa6d223a231b7f3ed6318ccd48092e798884376))
* **theme:** load the ACE language-tools extension where pages expect it ([d3d1592](https://github.com/Shofiul735/emailengine/commit/d3d1592cf704aa0624deef6df25f8fa9ead6904b))
* **theme:** render the API reference as a light island ([ddf696c](https://github.com/Shofiul735/emailengine/commit/ddf696caecc38ddbef9d52579b4cbea329658856))
* **theme:** repair the ACE editor toolbar chrome ([4f492f1](https://github.com/Shofiul735/emailengine/commit/4f492f116e2416f21b58b82f9543dc8fad2e63cb))
* **theme:** tooltip stacking, empty-bubble gating and badge rounding ([bdfea13](https://github.com/Shofiul735/emailengine/commit/bdfea138db55c1f20eba2d9106dcadd3e8a2ad5a))
* **theme:** use a real list for the gateway usage notes ([b860c28](https://github.com/Shofiul735/emailengine/commit/b860c2894432e4c36e5adec253a98b24ba37d10c))
* **theme:** use standard FlyonUI rounding on the auth pages ([96b7028](https://github.com/Shofiul735/emailengine/commit/96b7028fd5fa7efbcc682021eddeaebfce30ca4e))
* **tokens:** refuse to mint an access token before an admin password is set ([ff3dd47](https://github.com/Shofiul735/emailengine/commit/ff3dd47b06ebac2d7f861fe66e26549db193a9f8))
* translate OAuth scope error page across 6 languages ([4ae1919](https://github.com/Shofiul735/emailengine/commit/4ae19199fe628f8a4f7177d53db1f05167077e3e))
* **ui:** add a visible exit for the ACE editor fullscreen mode ([0378d82](https://github.com/Shofiul735/emailengine/commit/0378d82bdb4f624a422d6ba81b5f8c2b2f4ad39f))
* **ui:** admin UX round: search clear, secret copy, modal Cancel ([ff6def0](https://github.com/Shofiul735/emailengine/commit/ff6def00f89e271357ce8c3d553d53685d82bccd))
* **ui:** clarify the gateways help panel and add a docs link ([7f8a669](https://github.com/Shofiul735/emailengine/commit/7f8a669178a00e8b0a8ed1811f77c77f4898c226))
* **ui:** document Azure OpenAI endpoints and refresh the fallback AI model list ([defef18](https://github.com/Shofiul735/emailengine/commit/defef1832165069d6657ebdd9a6f0c261631105a))
* **ui:** flag recently restarted workers on the internals page ([435a932](https://github.com/Shofiul735/emailengine/commit/435a93233ca56c61c42f17d80fb2d4d39fb88381))
* **ui:** group the workers page by kind with pool health and descriptions ([8ae65a9](https://github.com/Shofiul735/emailengine/commit/8ae65a9e5942c2b24b76b2e815d56725567a3d59))
* **ui:** keep submitted values when a settings form fails validation ([f01bdef](https://github.com/Shofiul735/emailengine/commit/f01bdef5c92606e79ebaa6d7a68e278a0920def8))
* **ui:** left-align tooltip bubble text ([cc52213](https://github.com/Shofiul735/emailengine/commit/cc52213bbbcdf529dccd1a0f2b498f050bf18931))
* **ui:** link the dashboard Needs attention card to a real errors filter ([50763c5](https://github.com/Shofiul735/emailengine/commit/50763c5d64d037dcf9cb7a8729a92c03db7077e4))
* **ui:** make admin UI links visibly distinct from body text ([e9a4827](https://github.com/Shofiul735/emailengine/commit/e9a4827df4525c3b0fd4021700ddae1039f26003))
* **ui:** open the account toolbar dropdowns downward, not clipped ([cd18e5b](https://github.com/Shofiul735/emailengine/commit/cd18e5b904bd4934cb45cad3885902e9bb86505a))
* **ui:** restore the accounts list row-actions kebab ([b9b7134](https://github.com/Shofiul735/emailengine/commit/b9b7134e5e1cbae119a0a790f14895090993b7f9))
* **ui:** show the workers page Accounts column only for email workers ([d0fb2ef](https://github.com/Shofiul735/emailengine/commit/d0fb2efbb7fccb64469f2333e88d2a6768104bdf))
* **ui:** stop the row-actions kebab wrapper from trapping its open menu ([d86324d](https://github.com/Shofiul735/emailengine/commit/d86324d518b5ccc5a44118fff6104641c74ba92e))
* **ui:** the account-sync workers are not IMAP-only ([e99c05a](https://github.com/Shofiul735/emailengine/commit/e99c05a4577affb82e45140ccc772cefbd57d627))
* **ui:** use an inline docs link, not a button, in the templates help panel ([34c5dcc](https://github.com/Shofiul735/emailengine/commit/34c5dcc9a3152368d2811ff7888928a533c1368e))
* **ui:** warn that Document Store will be removed on 2026-10-01 ([1415af6](https://github.com/Shofiul735/emailengine/commit/1415af687e24d86846482c292065916c24a9dfae))
* untrack bailed subconnection clients and harden the revival trigger ([086a585](https://github.com/Shofiul735/emailengine/commit/086a585541d3c6d751ebfbfc34f8f15397d51407))
* untrack the IMAP client when connect() bails for a paused account ([cface66](https://github.com/Shofiul735/emailengine/commit/cface665f16d7ad00f7b657e07f3c3f77c3401ef))
* update client-side Handlebars to 4.7.9 and harden passkey input validation ([882891c](https://github.com/Shofiul735/emailengine/commit/882891c36ed3704d96ccf227e682e152f5395036))
* update connection tracking when replacing a previous IMAP client ([8e143c2](https://github.com/Shofiul735/emailengine/commit/8e143c281d03d3d226e65eaae32eab96b1db0671))
* update dependencies (@postalsys/ee-client 1.3.2, nodemailer 9.0.3, bullmq 5.79.2, @sentry/node 10.63.0, [@bull-board](https://github.com/bull-board) 8.0.2) ([b954f67](https://github.com/Shofiul735/emailengine/commit/b954f67e1250d8a0029d355a5a8c6fc9d7f00e8e))
* update dependencies (email-text-tools 2.4.10, email-ai-tools 1.13.10) ([73df05c](https://github.com/Shofiul735/emailengine/commit/73df05c02db79fc47623ee41e27a315952c289b1))
* update dependencies (libmime 5.4.0, mailparser 3.9.12, imapflow 1.4.3, email-ai-tools 1.13.9) ([8c999d8](https://github.com/Shofiul735/emailengine/commit/8c999d8c5e6b550c6d3a28fd4ec118c48d095901))
* update imapflow to 1.2.15 to fix unhandled rejection crashes ([494a3f8](https://github.com/Shofiul735/emailengine/commit/494a3f8cd9e71bc1fc1683bea2fc92474cb33206))
* upgrade handlebars to 4.7.9 to resolve prototype pollution vulnerability ([452f5f5](https://github.com/Shofiul735/emailengine/commit/452f5f54f4007e4b765e18861ce01cde312cc83c))
* upgrade joi to 17.13.4 and @postalsys/certs to 1.0.15 (GHSA-q7cg-457f-vx79) ([6ec77e5](https://github.com/Shofiul735/emailengine/commit/6ec77e50b288b14550cd09b724f5aab59d17ced4))
* use constant-time comparison for secret and MAC checks ([453caf3](https://github.com/Shofiul735/emailengine/commit/453caf3ac01e58248a3a7019aa4ec3c2179b3abc))
* use STATUS instead of NOOP as keepalive for 163.com IMAP ([3b3516f](https://github.com/Shofiul735/emailengine/commit/3b3516feb14e64bab5ac586378237f2160cdf010))
* use template literals for translated strings in showErrorPopup ([b56fd1f](https://github.com/Shofiul735/emailengine/commit/b56fd1fa7612b4cf2b7e99cbd78d7447b89c03c6))
* verify HMAC signature on the human-facing unsubscribe routes ([e30be83](https://github.com/Shofiul735/emailengine/commit/e30be836a71bc7e96baee19e5b019da5b0de40fa))
* **webhooks:** filter webhook egress and stop following redirects ([e44bed5](https://github.com/Shofiul735/emailengine/commit/e44bed549848d8eb2b04bb991aa2c6cee0bb47c2))
* **webhooks:** report the refused redirect status and probe through the delivery path ([9f7c666](https://github.com/Shofiul735/emailengine/commit/9f7c666f5e2a0bfae069a0c43c33a75d04922747))
* **webhooks:** stop retrying an endpoint that answers with a redirect ([bbb6055](https://github.com/Shofiul735/emailengine/commit/bbb605560d31bb494495b46a57cd233a78024d99))
* wire RPC channel into worker Account instances so OAuth re-auth reconnect does not crash ([7372bf5](https://github.com/Shofiul735/emailengine/commit/7372bf52e9cde06059691d42fd74b904a68235dc))


### Performance Improvements

* **docker:** cache the dependency install and smoke test the CLI in the image ([e275733](https://github.com/Shofiul735/emailengine/commit/e275733dacc85ba72ea3465013242785c2d7adcf))
* optimize mailbox listing for accounts with many folders ([a39e5f7](https://github.com/Shofiul735/emailengine/commit/a39e5f7b02156fc73ab44d1ca4f6e977e4290312))


### Reverts

* back out the OAuth2 token-failure rework, keep the delivery and token fixes ([496ac3d](https://github.com/Shofiul735/emailengine/commit/496ac3d9c8737fecaf5ccf21bf98d1bd51e7af5c))
...
* bump imapflow to 1.4.4 (dedupe nodemailer/iconv-lite) ([5acc8cd](https://github.com/postalsys/emailengine/commit/5acc8cd99f9179fabb8d8486cf23b0558e4514bf))
* bump imapflow/mailparser/mailsplit/email-ai-tools (collapse iconv-lite) ([51dcffb](https://github.com/postalsys/emailengine/commit/51dcffb3ff0f22f9b9634d078e58b35aaf7a0312))
* bump libmime/mailparser/smtp-server/pubface (uniform nodemailer) ([eee89bb](https://github.com/postalsys/emailengine/commit/eee89bb716655519c72fb922849272c1058cbc9a))
...
* gate hosted auth form with a single-use nonce and probe cap, harden serviceSecret ([7ea4ff7](https://github.com/postalsys/emailengine/commit/7ea4ff7e6ca4d9239201f556b24ebd9cf8ab8250))
* harden hosted authentication form (SSRF gate, fail-closed HMAC, XSS) ([4267df7](https://github.com/postalsys/emailengine/commit/4267df7fd0252aa84ff1d257846126a8f943bf1a))
...
* override grunt's transitive js-yaml to 3.15.0 (GHSA-h67p-54hq-rp68) ([024a923](https://github.com/postalsys/emailengine/commit/024a923de3ff2a880e79c7ddbf34bbc058fcbea3))
...
* update dependencies (email-text-tools 2.4.10, email-ai-tools 1.13.10) ([73df05c](https://github.com/postalsys/emailengine/commit/73df05c02db79fc47623ee41e27a315952c289b1))
