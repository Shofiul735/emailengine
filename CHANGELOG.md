...
## [2.78.0](https://github.com/Shofiul735/emailengine/compare/v2.77.0...v2.78.0) (2026-08-07)
...
* **accounts:** pin an account to an expected email identity ([a64bb60](https://github.com/Shofiul735/emailengine/commit/a64bb6009163bed0835cb3f8342e5d0ec20549b3)), closes [#626](https://github.com/Shofiul735/emailengine/issues/626)
...
* **admin-ui:** keep the access-token banner in view and make the reference nav usable on a phone ([a4bb55f](https://github.com/Shofiul735/emailengine/commit/a4bb55f7a416a74c65b50a0b69879b5b21915711))
* **admin:** make the API reference searchable by field name and linkable per property ([65acf52](https://github.com/Shofiul735/emailengine/commit/65acf52a79d0002d7cd7cec7e2466f17dea06f13))
* **admin:** mark the operation being read in the API reference sidebar ([700eab7](https://github.com/Shofiul735/emailengine/commit/700eab7716bec0362b73bf5e8f498be971071e7e))
...
* **api:** generate the OpenAPI document without hapi-swagger ([4a87b29](https://github.com/Shofiul735/emailengine/commit/4a87b2953d136cbc1f9e44786c7dab2d3ce1cc34))
...
* **accounts:** let a wrong-account setup be retried instead of bouncing it back ([4cd6ac4](https://github.com/Shofiul735/emailengine/commit/4cd6ac4d0b935244accc55b1f9abb41cf906a2dc))
...
* **accounts:** remove the messages an account had queued when it is deleted ([ba6897f](https://github.com/Shofiul735/emailengine/commit/ba6897f4a5966a1a0dcddd7c514a3804e31591c4))
...
* **assignment:** do not 500 when an account is created before the first worker is ready ([7c8e5df](https://github.com/Shofiul735/emailengine/commit/7c8e5dfaf8e06458b124b5c740a1ad917ff76f94))
...
* **bounces:** read every block of a delivery-status body ([a99878e](https://github.com/Shofiul735/emailengine/commit/a99878eaf2970b36a7cc0ac50a725292405c6ab3))
...
* **deps:** update dependencies (libmime 5.4.2, nodemailer 9.0.5, imapflow 1.6.6) ([abd8034](https://github.com/Shofiul735/emailengine/commit/abd8034d1e365c5e523a361a0379649fa9c6c29c))
* **deps:** update our own packages so the tree carries one copy of each ([4a6e79f](https://github.com/Shofiul735/emailengine/commit/4a6e79fcaf2d11a35870e557c4a8e6756d05b4b4))
...
* **encrypt:** rotate every stored secret, not just the ones the tool remembered ([35a2cc0](https://github.com/Shofiul735/emailengine/commit/35a2cc0886c718945f94989799aeef7cda1db8f3))
...
* **oauth2:** honor useAuthServer on the IMAP and SMTP paths ([0c5c43d](https://github.com/Shofiul735/emailengine/commit/0c5c43da4b4190bba4e41ecbfa4c24b2e8627397))
...
* **openapi:** do not shadow require() in the schema converter ([a63bf90](https://github.com/Shofiul735/emailengine/commit/a63bf90435eef459513e78f7ed549607923d428a))
...
* **tokens:** reap expired tokens from the listing, not only on use ([2564831](https://github.com/Shofiul735/emailengine/commit/2564831d1b533b26a0c07dabd981a01a36c21e08))
...
* **webhooks:** bind the egress check to the address actually connected to ([#631](https://github.com/Shofiul735/emailengine/issues/631)) ([2d68b37](https://github.com/Shofiul735/emailengine/commit/2d68b37a1d186c7f9894e4b1425c1c52870c7cb5))
...
* **accounts:** unlink the account keys instead of deleting them inline ([ec11210](https://github.com/Shofiul735/emailengine/commit/ec11210a750021c1ccbf2df3637816974c0f995c))
